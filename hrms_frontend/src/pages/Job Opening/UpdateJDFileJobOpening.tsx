...
import { useUpdateFileJobOpening } from '../../hooks/useUpdateFileJobOpening';
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <main className="flex-1 bg-neutral-950 text-white p-6 overflow-y-auto">
                    <div className="text-center mt-8 mb-8">
                        <h1 className="text-4xl font-bold text-center text-white mb-4">Update Job Description File</h1>
                    </div>
                    <form
                        ...
                        <div className="md:col-span-2">
                            <button
                                ...
                                Update Job Opening Description FIle
                            </button>
                        </div>
                    </form>
                </main>
...
export default UpdateJDFileJobOpening