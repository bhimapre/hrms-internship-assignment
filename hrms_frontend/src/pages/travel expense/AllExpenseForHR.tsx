...
import { useTotalTravelExpenseApproved } from '../../hooks/travelExpense/useTotalExpenseApproved';
...
const AllExpenseForHR = () => {
  ...
  const { data: total } = useTotalTravelExpenseApproved(travelId);
    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 bg-neutral-950 text-white p-6 overflow-y-auto">
          <Box p={4}>
            <Typography variant="h5" mb={3} color='green'>
              Total Expense Of This Travel: {total}
            </Typography>
